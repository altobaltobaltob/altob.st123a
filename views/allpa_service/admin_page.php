...
<head>
    ...
    <title>歐特儀停車場 (<?=STATION_NAME?>) - 歐Pa卡 (管理)</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=APP_URL?>">歐特儀停車場 (<?=STATION_NAME?>) (管理)</a>
            </div>
                    ...
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="#" onclick="get_allpa_admin_products(event);">管理員加值</a>
                                </li>
								<!--li>
        ...
        <div id="page-wrapper">            
			...
			<?php /* ----- 加值清單  ----- */ ?> 
            <div data-items="allpa_admin_products" class="row" style="display:none;">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                                    ...
                                    <tbody id="available_curr_tbody" style="font-size:14px;">
                                        ...
                                        <tr>
                                            <td style="text-align:right;vertical-align: middle;">
												<button type="button" class="btn btn-default" onclick="transfer_money_admin(event);">開始付款</button>
                                            </td>
                                            <td style="text-align:left;vertical-align: middle;">
												<button type="button" class="btn btn-default" onclick="show_item('allpa_admin_products');">取消</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
								...
								<div data-rows class="row">
									<div class="col-lg-6">
										<!--div class="col-lg-8 col-lg-offset-2 text-center">
											<h3 class="section-heading">使用條款、一</h2>
											<hr class="light">
											※本卡僅限一卡設定一台車號，車主或持卡人同意於本公司全台停車場停車出場時，自動於歐趴卡扣除停車費。
										</div>
										<div class="col-lg-8 col-lg-offset-2 text-center">
											<h3 class="section-heading">使用條款、二</h2>
											<hr class="light">
											※如遇歐趴卡餘額不足時請於出場前進行加值；若無法扣款則需請車主或持卡人自行以其他方式繳付停車費。
										</div>
										<div class="col-lg-8 col-lg-offset-2 text-center">
											<h3 class="section-heading">使用條款、三</h2>
											<hr class="light">
											※本卡提供記名服務，若消費者選擇不記名時，使用認卡不認人，若卡片遺失、遭竊、詐取、毀損至系統無法辯識或遭第三人佔領等情事發生，儲值金額等同現金遺失，恕無法提供儲值金額賠償或掛失止付，請消費者妥善保管使用；若完成記名作業，如遇卡片遺失可逕向本公司申請掛失、補發新卡及餘額返還，惟補發新卡費用將酌收50元。
										</div>
										<div class="col-lg-8 col-lg-offset-2 text-center">
											<h3 class="section-heading">使用條款、四</h2>
											<hr class="light">
											※退卡作業：如卡片使用後尚有餘額，請逕自將餘額用罄，恕不退還。
										</div>
										<div class="col-lg-8 col-lg-offset-2 text-center">
											<h3 class="section-heading">使用條款、五</h2>
											<hr class="light">
											※本卡所收取之金額，已存入發行人於中國信託商業銀行開立之信託專戶，專款專用；所稱專用係指供發行人履行交付商品或提供服務義務使用。本信託受益人為發行人，非本卡持有人，信託期間自開卡日起一年，託存續期間屆滿後，由中國信託商業銀行將信託專戶餘額交由發行人領回。
										</div-->	
										<div class="col-lg-8 col-lg-offset-2 text-center">
...
// 開啟轉帳畫面
function transfer_money_admin(event)
{
	event.preventDefault();
...
function do_purchase(product_id)
{
	$.ajax
	({
		url: "<?=APP_URL?>purchase_admin_products",
		type: "post",
		dataType:"text",
		data:{
...
// 管理員加值清單
function get_allpa_admin_products(event)
{
	event.preventDefault();
	
	$.ajax
	({
		url: "<?=APP_URL?>get_allpa_admin_products",
		type: "post",
		dataType:"text",
		success: function(result)
		{
			...
			show_item('allpa_admin_products');
		},
		error: function (xhr, ajaxOptions, thrownError) 
		{
			alertify_error("發生未知錯誤, 請稍候再試");
